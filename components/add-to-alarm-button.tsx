...
import { BellPlus, CheckCircle2, PlusCircle } from 'lucide-react';
...
export function AddToAlarmButton({ productId, categoryId }: { productId: string; categoryId?: string | null }) {
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-100">
                            <button
                                ...
                                onClick={(e) => {
                                    ...
                                    setTimeout(() => router.push(`/alarms/new${qs}`), 0);
                                }}
                                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-dashed border-blue-200 text-blue-600 font-medium hover:bg-blue-50 transition-colors"
                            >
